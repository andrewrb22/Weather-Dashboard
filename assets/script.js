let apiKey = "8c6231702f6c6ef3ea8b552733361b14";
...
// create a function to search for the value of the input
...
function renderSearchHistory(cityName) {
    ...
    for (let i = 0; i < searchHistoryArr.length; i++) {
        // create a new element inside the loop
        let newListItem = $("<li>").attr("class", "historyEntry");
        newListItem.text(searchHistoryArr[i]);
        searchHistoryEl.prepend(newListItem);
    }
}
//create function to add text to each element
...
//create function getWeather to obtain data from the object
...
// store our array of searches and save 
    ...
    getFiveDayForecast();
//create function to get 5 days forecaste
...
//create function to add date,icon,temperatura and huminity
